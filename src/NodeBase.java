 ...
 * Date:
 * Description: this program implements Node Base Algorithm
 */
public class NodeBase {
    ...
    public NodeBase(int[] dataGens, int[] storageNodes, int dataPerDG, int spacePerSt, Map<String, Link> copytreeMap) {
...
//                        System.out.println(Arrays.toString(pq.toArray()));
        ...
        // after all calculation the result will be data resilient
...
//                System.out.println("Data Resilience:");
//                System.out.println(dataresilient);
            }
        }
        ...
        System.out.println("\nEnergy List:");
        System.out.println(Arrays.toString(energyList));
        System.out.println("\nThe Resilience in Node Base:");
        System.out.println(dataResilience);
        System.out.println("\nThe Total Energy Cost in Node Base:");
        System.out.println(totalEnergyCost);
